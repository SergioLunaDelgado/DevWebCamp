...
<section class="resumen">
    <div class="resumen__grid">
        <div <?php aos_animation(); ?> data-aos-duration="1000" class="resumen__bloque">
...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoces a nuestros expertos en DevWebCamp</p>
        ...
        <?php foreach ($ponentes as $ponente) : ?>
            <div <?php aos_animation(); ?> class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" width="200" height="300" loading="lazy" src="/img/speakers/<?php echo $ponente->imagen ?>.png" alt="Imagen Ponente">
                </picture>
                <div class="speaker__informacion">
                    <div class="speaker__nombre">
