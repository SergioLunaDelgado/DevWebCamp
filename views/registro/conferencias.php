...
<div class="eventos-registro">
    <main class="eventos-registro__listado">
        ...
        <p class="eventos-registro__fecha">Lunes 18 de Diciembre</p>
        ...
        <p class="eventos-registro__fecha">Martes 19 de Diciembre</p>
        <div class="eventos-registro__grid">
    ...
    <aside class="registro">
        ...
        <div id="registro-resumen" class="registro__resumen"></div> <!-- js -->
